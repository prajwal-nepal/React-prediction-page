// Function to fetch the predicted age based on the given name
...
// Function to fetch the predicted gender based on the given name
...
// Function to fetch the predicted nationality based on the given name
...
async function Prediction({ params }: Params) {
  ...
  const [age, gender, nationality] = await Promise.all([
    ...
    // Return the JSX for displaying the predictions
  return (
